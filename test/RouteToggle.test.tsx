...
describe('RouteToggle', () => {
  ...
  const Component = (
    props: any // eslint-disable-next-line
  ) => (
    <div>
      hi{' '}
  ...
  describe('initialized', () => {
    ...
    test('does not render the component if the route matches, but other does not', () => {
    ...
    test('componentLoadingMap', () => {
      ...
      const container = renderComponent(
        R,
        { component: Show, bobby: 'hi', frenzel: 'there', blah: 'oops' },
        {
          week: 1,
          routing: {
            location: {
